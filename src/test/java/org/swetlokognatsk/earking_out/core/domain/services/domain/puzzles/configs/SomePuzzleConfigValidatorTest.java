...
public final class SomePuzzleConfigValidatorTest {
    ...
    public void thisTargetNumberOfPuzzlesFails(final int targetNumberOfPuzzles) {
        ...
        assertThesePropertiesLedToErrors(validationResult, List.of(PuzzleConfigAggregate.TARGET_NUMBER_OF_PUZZLES_PROP));
    }
    ...
    public void positiveTargetNumberOfPuzzlesIsOk() {
        ...
        assertNoValidationErrors(validationResult);
    }
}
