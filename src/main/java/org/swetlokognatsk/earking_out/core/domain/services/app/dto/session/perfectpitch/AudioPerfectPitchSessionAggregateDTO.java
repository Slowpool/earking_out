...
public final class AudioPerfectPitchSessionAggregateDTO extends SessionAggregateDTO<AudioPerfectPitchExercise, AudioPerfectPitchPuzzle, AudioPerfectPitchConfigDTO, AudioPerfectPitchSessionAggregate> {
    ...
    public AudioPerfectPitchSessionAggregateDTO(final AudioPerfectPitchConfigDTO puzzleConfigDto, final GeneralSessionStats stats, final SessionStates state, final AudioPerfectPitchPuzzle puzzle, final Boolean prevGuessIsSuccessful, final Integer numberOfGuessesOfCurrentPuzzle) {
