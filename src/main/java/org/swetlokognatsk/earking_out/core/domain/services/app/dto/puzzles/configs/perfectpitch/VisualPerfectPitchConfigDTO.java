...
public final class VisualPerfectPitchConfigDTO extends PerfectPitchConfigDTO<VisualPerfectPitchExercise> {
    ...
    public VisualPerfectPitchConfigDTO(final VisualPerfectPitchExercise exercise, final int targetNumberOfPuzzles, final boolean statsRecording, byte[] normalizedNotesForPuzzle, final Byte normalizedRootNote, final PerfectPitchInputMode inputMode) {
