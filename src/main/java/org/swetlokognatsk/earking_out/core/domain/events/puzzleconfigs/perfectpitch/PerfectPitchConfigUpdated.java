...
import org.swetlokognatsk.earking_out.core.domain.events.puzzleconfigs.PuzzleConfigUpdated;
...
class PerfectPitchConfigUpdated<E extends PerfectPitchExercise, PC extends PerfectPitchConfig<E>> extends PuzzleConfigUpdated<E, PC> {
    ...
    public PerfectPitchConfigUpdated(LocalDateTime timestamp, E exercise, PC newConfig) {
