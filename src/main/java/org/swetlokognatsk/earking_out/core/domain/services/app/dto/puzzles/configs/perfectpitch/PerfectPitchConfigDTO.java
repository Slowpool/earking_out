...
public abstract class PerfectPitchConfigDTO<E extends PerfectPitchExercise> extends PuzzleConfigDTO<E> {
    ...
    public PerfectPitchConfigDTO(final E exercise, final int targetNumberOfPuzzles, final boolean statsRecording, PianoKeyNumber[] normalizedNotesForPuzzle, final PianoKeyNumber normalizedRootNote, final PerfectPitchInputMode inputMode) {
