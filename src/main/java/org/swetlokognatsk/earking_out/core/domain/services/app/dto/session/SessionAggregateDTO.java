...
public abstract class SessionAggregateDTO<E extends Exercise, P extends Puzzle<E, ?>, PCDTO extends PuzzleConfigDTO<E>, SA extends SessionAggregate<E, ?, P, PCDTO>> {
    ...
    public SessionAggregateDTO(final PCDTO puzzleConfigDto, final GeneralSessionStats stats, final SessionStates state, final P puzzle, final Boolean prevGuessIsSuccessful, final Integer numberOfGuessesOfCurrentPuzzle) {
