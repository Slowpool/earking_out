...
public class AudioPerfectPitchConfigDTOAssembler extends PerfectPitchConfigDTOAssembler<AudioPerfectPitchExercise, AudioPerfectPitchConfigAggregate, AudioPerfectPitchConfigDTO> {
    ...
    public AudioPerfectPitchConfigDTO assemble(final AudioPerfectPitchConfigAggregate aggregate) {
        var dto = new AudioPerfectPitchConfigDTO(aggregate.getId(), aggregate.getTargetNumberOfPuzzles(), aggregate.getStatsRecording(), aggregate.getNormalizedNotesForPuzzle(), aggregate.getNormalizedRootNote(), aggregate.getInputMode(), aggregate.getSoundlessGuessingPiano(), aggregate.getSoundlessSuccessfulGuess());
        return dto;
    }
}
