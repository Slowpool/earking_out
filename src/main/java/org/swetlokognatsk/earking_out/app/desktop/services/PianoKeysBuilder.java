...
public final class PianoKeysBuilder implements Iterator<PianoKey> {
    ...
    private double calculateBlackKeyWidth() {
        return whiteKeyWidth * Constants.BLACK_KEY_WIDTH_RELATIVELY_TO_WHITE_KEY_WIDTH;
    }

    private double calculateBlackKeyHeight() {
        return whiteKeyHeight * Constants.BLACK_KEY_LENGTH_RELATIVELY_TO_WHITE_KEY_LENGTH;
    }
    ...
    public boolean hasNext() {
        return (currentKeyIndex + 1) < Constants.PIANO_KEYS_NUMBER;
    }
