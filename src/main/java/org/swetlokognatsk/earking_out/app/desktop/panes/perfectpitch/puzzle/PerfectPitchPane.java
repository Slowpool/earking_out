...
public abstract class PerfectPitchPane<E extends PerfectPitchExercise, PC extends PerfectPitchConfigAggregate<E>, H extends Hint, PG extends PerfectPitchPuzzleGenerator<PC>, P extends PerfectPitchPuzzle<E, PC, H, PG>> extends PuzzlePane<E, PC, H, PG, P> {
